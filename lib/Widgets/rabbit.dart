...
class RabbitPainter extends CustomPainter {
  ...
  RabbitPainter(
      {required this.controller, required Map<String, Animation> animationMap})
  ...
  Path createRadishLeafPath(
    ...
    var point1 = Offset(leftHandsFeetPoints.first.dx + 20.w,
        leftHandsFeetPoints.first.dy - 5.w);
    var point2 = Offset(leftHandsFeetPoints.first.dx - 5.w,
        leftHandsFeetPoints.first.dy - 45.w);
    var point3 = Offset(leftHandsFeetPoints.first.dx + 5.w,
        leftHandsFeetPoints.first.dy - 45.w);
    var point4 = Offset(leftHandsFeetPoints.first.dx + 35.w,
        leftHandsFeetPoints.first.dy - 10.w);
    var point5 = Offset(leftHandsFeetPoints.first.dx + 40.w,
        leftHandsFeetPoints.first.dy - 35.w);
    var point6 = Offset(
        rightFirstPosition.dx + 0.w, leftHandsFeetPoints.first.dy - 35.w);
    var point7 = Offset(leftHandsFeetPoints.first.dx + 50.w,
        leftHandsFeetPoints.first.dy - 5.w);
  ...
  void drawRightEarFill(Canvas canvas, Offset rightFirstPosition) {
    ...
    var rightEarRect = Rect.fromLTWH(
        rightFirstPosition.dx - 23.w, 25.w, 30.w, rightFirstPosition.dy - 30.w);
